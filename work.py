...
fig=ex.line(df, x=df.index, y=['Adj Close','bb_lower','bb_upper'], title='台鋼  Adj Close with Bollinger Bands')
fig.update_layout(title_text=f'台鋼 Adj Close with Bollinger Bands', title_x=0.5);
